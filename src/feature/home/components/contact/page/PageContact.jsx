...
function PageContact() {
   ...
   const largeScreen1 = useMediaQuery('(min-width:1024px)');
   console.log("???:",largeScreen,':',largeScreen1)
   if(largeScreen===false){
      checked=true
   }
   return (
      <Box  sx={{ height: "100vh",position: "relative",display:"flex", justifyContent:"center",padding:"50px",'@media ( max-width: 1024px)':{
         height:"100%",
         padding: "0px 50px"
      }}}> 
