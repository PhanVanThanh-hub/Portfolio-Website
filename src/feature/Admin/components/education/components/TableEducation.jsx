...
import ModelAddEducation from './ModelAddEducation';
...
export default function TableEducation(props) {
   ...
   const show = useSelector(state => state.education.show)
   ...
   const deleteProduct = (data)=>{
      const response= cvApi.deleteEducation(data);
   ...
   return (
      ...
      <TableContainer component={Paper} sx={{width:"100%",borderRadius:"12px"}}>
         ...
         <TableBody>
            {props.education.map((product,index)=>
